...
void ItemShopState::show_sell_option_label(Platform& pfrm, Game& game)
{
    if (selector_x_ == 1) {
        ...
        show_label(pfrm, game, locale_string(pfrm, LocaleString::store_info)->c_str(), false);
    }
}
...
void ItemShopState::show_buy_option_label(Platform& pfrm, Game& game)
{
    if (selector_x_ == 1) {
        ...
        show_label(pfrm, game, locale_string(pfrm, LocaleString::store_info)->c_str(), true);
    }
}
...
StatePtr ItemShopState::update(Platform& pfrm, Game& game, Microseconds delta)
{
    ...
    case DisplayMode::animate_in_buy: {
        ...
        if (timer_ > anim_duration) {
            ...
            show_label(
                       pfrm, game, locale_string(pfrm, LocaleString::store_buy_items)->c_str(), true);
