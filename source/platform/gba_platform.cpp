...
bool rx_current_all_zeroes = true; // The multi serial io mode always
                                   // transmits, even when there's nothing to
                                   // send. At first, I was allowing zeroed out
                                   // messages generated by the platform to
                                   // pass through to the user. But doing so
                                   // takes up a lot of space in the rx buffer,
                                   // so despite the inconvenience, for
                                   // performance reasons, I am going to have
                                   // to require that messages containing all
