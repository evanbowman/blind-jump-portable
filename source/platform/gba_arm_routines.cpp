...
#define DCNT_BG2 0x0400
    ...
    irqDisable(IRQ_VBLANK | IRQ_HBLANK | IRQ_VCOUNT | IRQ_TIMER0 | IRQ_TIMER1 | IRQ_TIMER2 | IRQ_TIMER3 | IRQ_SERIAL | IRQ_DMA0 | IRQ_DMA1 | IRQ_DMA2 | IRQ_DMA3 | IRQ_KEYPAD | IRQ_GAMEPAK);
