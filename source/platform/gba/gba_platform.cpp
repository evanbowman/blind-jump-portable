...
alignas(2) static const u8 gbp_logo_palette[] = {
...
alignas(2) static const u8 gbp_logo_tiles[] = {
...
alignas(2) static const u8 gbp_logo_pixels[] = {
...
static void do_gameboy_player_logo_sequence(Platform& pfrm)
{
    ...
    *bg0_control = 0x0088;
    ...
    for (int i = 0; i < 240; ++i) {
        ...
        if (pfrm.keyboard().pressed<Key::up>() and
            pfrm.keyboard().pressed<Key::down>() and
            pfrm.keyboard().pressed<Key::left>() and
            pfrm.keyboard().pressed<Key::right>()) {
